...
def woe_bin(x, y, 
    ...
    Extension of the three-stage monotonic binning procedure (iso_bin)
    ...
    and target rate, while the last stage is iterative merging of  
    bins until WoE threshold is exceeded.
            ...
            ------------
                    ...
                    woe_gap Minimum WoE gap between bins. Default is 0.1.
